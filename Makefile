...
ifeq ($(config),debug64)
  ...
  DEFINES   += -DDEBUG
  INCLUDES  += -I.. -I../src/gKit -I$(rootdir)/libpng/include
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -m64 -L/usr/lib64 -flto -g -L$(rootdir)/libpng/lib
...
ifeq ($(config),release64)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -s -m64 -L/usr/lib64 -flto -fopenmp -L$(rootdir)/libpng/lib
  LIBS      += -lGLEW -lSDL2 -lSDL2_image -lGL -lpng -lz
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(ARCH) $(LIBS)
...
ifeq ($(config),debug32)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -m32 -L/usr/lib32 -flto -g -L$(rootdir)/libpng/lib
  LIBS      += -lGLEW -lSDL2 -lSDL2_image -lGL -lpng -lz
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(ARCH) $(LIBS)
...
ifeq ($(config),release32)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -s -m32 -L/usr/lib32 -flto -fopenmp -L$(rootdir)/libpng/lib
  LIBS      += -lGLEW -lSDL2 -lSDL2_image -lGL -lpng -lz
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(ARCH) $(LIBS)
